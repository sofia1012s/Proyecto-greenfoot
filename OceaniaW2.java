...
public class OceaniaW2 extends World
{
    ...
    public OceaniaW2() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Oceania2(),665,219);//añade la imagen al mundo
        addObject (new OW3(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(oceania2A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(oceania1A) || Greenfoot.mouseClicked(oceania3A) || Greenfoot.mouseClicked(oceania4A) || Greenfoot.mouseClicked(oceania5A))
    ...
    public void Order() //permite tener las opciones de respuestas en ordenes distintos 
    {
        ...
        else if( order == 2)//tercer orden aleatorio
        {
            ...
            addObject (oceania2A,239,533);
        }
    }

    public void addScore(int points)//añade el puntaje al mundo
    {
        score = OceaniaW1.score + points; //suma los puntos correctos
