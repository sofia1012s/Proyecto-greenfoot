...
public class EuropaW5 extends World
{
    ...
    public EuropaW5() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Europa5(),665,219);//añade la imagen al mundo
        addObject (new WSE(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(europa5A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(europa1A) || Greenfoot.mouseClicked(europa2A) || Greenfoot.mouseClicked(europa3A) || Greenfoot.mouseClicked(europa4A))
    ...
    {
        score = EuropaW4.score + points; //suma los puntos correctos
