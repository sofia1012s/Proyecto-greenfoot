...
public class AmericaW2 extends World
{
    ...
    public AmericaW2() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new America2(),665,219);//añade la imagen al mundo
        addObject (new MW3(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(america2A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(america1A) || Greenfoot.mouseClicked(america3A) || Greenfoot.mouseClicked(america4A) || Greenfoot.mouseClicked(america5A))
    ...
    public void Order() //permite tener las opciones de respuestas en ordenes distintos 
    {
        ...
        { 
            addObject (america5A,239,533);
            addObject (america2A,668,532);
    ...
    {
        score = AmericaW1.score + points; //suma los puntos correctos
