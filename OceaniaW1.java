...
public class OceaniaW1 extends World
{
    ...
    public OceaniaW1() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Oceania1(),665,219);//añade la imagen al mundo
        addObject (new OW2(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(oceania1A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(oceania2A) || Greenfoot.mouseClicked(oceania3A) || Greenfoot.mouseClicked(oceania4A) || Greenfoot.mouseClicked(oceania5A))
