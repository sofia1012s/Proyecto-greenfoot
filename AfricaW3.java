...
public class AfricaW3 extends World
{
    ...
    public AfricaW3() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Africa3(),665,219);//añade la imagen al mundo
        addObject (new AW4(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(africa3A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(africa1A) || Greenfoot.mouseClicked(africa2A) || Greenfoot.mouseClicked(africa4A) || Greenfoot.mouseClicked(africa5A))
    ...
    {
        score = AfricaW2.score + points; //suma los puntos correctos
