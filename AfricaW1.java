...
public class AfricaW1 extends World
{
    ...
    public AfricaW1() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Africa1(),665,219);//añade la imagen al mundo
        addObject (new AW2(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(africa1A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(africa2A) || Greenfoot.mouseClicked(africa3A) || Greenfoot.mouseClicked(africa4A) || Greenfoot.mouseClicked(africa5A))
