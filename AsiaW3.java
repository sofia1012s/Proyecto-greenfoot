...
public class AsiaW3 extends World
{
    ...
    public AsiaW3() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Asia3(),665,219);//añade la imagen al mundo
        addObject (new SW4(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(asia3A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(asia1A) || Greenfoot.mouseClicked(asia2A) || Greenfoot.mouseClicked(asia4A) || Greenfoot.mouseClicked(asia5A))
    ...
    {
        score = AsiaW2.score + points; //suma los puntos correctos
