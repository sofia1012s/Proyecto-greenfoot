...
public class AmericaW1 extends World
{
    ...
    public AmericaW1() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new America1(),665,219);//añade la imagen al mundo
        addObject (new MW2(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(america1A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(america2A) || Greenfoot.mouseClicked(america3A) || Greenfoot.mouseClicked(america4A) || Greenfoot.mouseClicked(america5A))
