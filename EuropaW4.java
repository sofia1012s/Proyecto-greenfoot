...
public class EuropaW4 extends World
{
    ...
    public EuropaW4() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Europa4(),665,219);//añade la imagen al mundo
        addObject (new EW5(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(europa4A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(europa1A) || Greenfoot.mouseClicked(europa2A) || Greenfoot.mouseClicked(europa3A) || Greenfoot.mouseClicked(europa5A))
    ...
    {
        score = EuropaW3.score + points; //suma los puntos correctos
