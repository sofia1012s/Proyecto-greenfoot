...
public class AsiaW2 extends World
{
    ...
    public AsiaW2() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Asia2(),665,219);//añade la imagen al mundo
        addObject (new SW3(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(asia2A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(asia1A) || Greenfoot.mouseClicked(asia3A) || Greenfoot.mouseClicked(asia4A) || Greenfoot.mouseClicked(asia5A))
    ...
    {
        score = AsiaW1.score + points; //suma los puntos correctos
