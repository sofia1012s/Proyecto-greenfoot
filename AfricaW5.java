...
public class AfricaW5 extends World
{
    ...
    public AfricaW5() //agregando objetos al mundo
    {    
        super(1300, 700, 1); //tamaño del mundo
        addObject (new Africa5(),665,219);//añade la imagen al mundo
        addObject (new WSA(),1249,326);//añade boton siguiente para pasar a la siguiente pregunta
    ...
    public void act()//añade 1 punto al contador
    {
        if (clickCount<1)
        {
            if (Greenfoot.mouseClicked(africa5A))//Respuesta correcta
            {
            ...
            if (Greenfoot.mouseClicked(africa1A) || Greenfoot.mouseClicked(africa2A) || Greenfoot.mouseClicked(africa3A) || Greenfoot.mouseClicked(africa4A))
    ...
    {
        score = AfricaW4.score + points; //suma los puntos correctos
